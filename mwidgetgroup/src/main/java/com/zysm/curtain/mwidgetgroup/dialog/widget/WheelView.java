...
package com.zysm.curtain.mwidgetgroup.dialog.widget;
...
import com.zysm.curtain.mwidgetgroup.dialog.adapter.WheelAdapter;
import com.zysm.curtain.mwidgetgroup.dialog.listener.OnWheelChangedListener;
import com.zysm.curtain.mwidgetgroup.dialog.listener.OnWheelScrollListener;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable == null) {
            centerDrawable = ContextCompat.getDrawable(mContext,R.drawable.dialogui_wheel_val);
        }
