...
import com.zysm.curtain.mwidgetgroup.dialog.adapter.StrericWheelAdapter;
...
public class DateSelectorWheelView extends RelativeLayout implements
    ...
    public String getSelectedDate() {
        ...
        if(tvMonth.getText().equals("")){
            tvMonth.setText(""+(currentMonth>9 ? currentMonth : "0"+currentMonth));
        }
